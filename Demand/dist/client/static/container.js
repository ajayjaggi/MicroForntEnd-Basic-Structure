...
var moduleMap = {
	"./Header": () => {
		return Promise.all([__webpack_require__.e("webpack_sharing_consume_default_react_react"), __webpack_require__.e("src_components_header_index_js")]).then(() => () => (__webpack_require__(/*! ./src/components/header */ "./src/components/header/index.js")));
	}
};
